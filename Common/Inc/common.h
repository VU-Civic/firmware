...
#define HISTORICAL_ONSET_MSG_HEADER_BYTES    36   // offsetof(historical_onset_message_t, onsets): 8+4+12+12
#define HISTORICAL_ONSET_ENTRY_BYTES         28   // sizeof(historical_onset_t): 8+4+12+4
#define HISTORICAL_ONSETS_MAX_BY_WINDOW      (HISTORICAL_ONSETS_SEARCH_SECONDS * AUDIO_NUM_DMAS_PER_CLIP)
#define HISTORICAL_ONSETS_MAX_BY_PAYLOAD     ((CELL_MQTT_MAX_PAYLOAD_SIZE_BYTES - HISTORICAL_ONSET_MSG_HEADER_BYTES) / HISTORICAL_ONSET_ENTRY_BYTES)
#define HISTORICAL_ONSETS_MAX_RESULTS        MIN(HISTORICAL_ONSETS_MAX_BY_WINDOW, HISTORICAL_ONSETS_MAX_BY_PAYLOAD)
...
#define AOA_MIN_ELEVATION_DEG                -45.0f
